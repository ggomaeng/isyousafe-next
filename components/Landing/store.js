...
const state = {
  ...
  diamonds: [
    { x: 0, offset: 0.15, pos: new Vector3(), scale: 0.4, factor: 4 },
    { x: 2, offset: 1.1, pos: new Vector3(), scale: 0.1, factor: 2.1 },
    { x: -5, offset: 2, pos: new Vector3(), scale: 0.1, factor: 2.5 },
    { x: 0, offset: 3.2, pos: new Vector3(), scale: 0.1, factor: 1.75 },
    { x: 0, offset: 4, pos: new Vector3(), scale: 0.1, factor: 2.5 },
    { x: 2, offset: 5.5, pos: new Vector3(), scale: 0.1, factor: 0.85 },
    { x: -5, offset: 7, pos: new Vector3(), scale: 0.1, factor: 2 },
    { x: 0, offset: 8, pos: new Vector3(), scale: 0.1, factor: 6 }
  ],
  top: createRef()
}
